...
<body>
	...
	<table id=tb2 align=center>
		<tr>
			<td class="ho-name1" colspan=6>${alist1[0].hname}<hr
					class="ho-hr1"></td>
		</tr>
		<tr>
			<c:forEach var="i" begin="0" end="2">
				<form action="detailCheck.do" method=post>
					...
					<td colspan=2>
						...
						<input class="img${i}" type="image" name=submit id=room src="./resources/img/${i}.svg" />
					</td>
				</form>
			</c:forEach>
		</tr>
		...
		<table id=tb2 align=center>
			<tr>
				<td class="ho-name2" colspan=6><h3>${alist1[3].hname}</h3>
					<hr></td>
			</tr>
